...
# Пункт 1. Обраний проєкт

**Проєкт:** ContentFlow

ContentFlow — це хмарний сервіс для адміністрування WordPress-сайтів та автоматизації створення SEO-контенту. Система дозволяє генерувати описи товарів за допомогою ШІ, керувати пресетами, підключати сайти через API та публікувати контент в один клік.

**Виконали:** Рогозян Артем, Самбуріна Єва, Старченко Олександр
